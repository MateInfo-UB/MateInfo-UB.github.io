    ...
    <div style={{
      ...
      <Card elevation={3} style={cardStyle}>
        ...
        <a href="https://fmi.unibuc.ro/concursul-mateinfoub/" target='_blank' rel='noreferrer'>
          <Button intent="primary">Deschide Pagina Concursului de pe Site-ul FMI</Button>
        </a>
      </Card>
      ...
      <Card elevation={3} style={cardStyle}>
        ...
        <a href="https://github.com/MateInfo-UB" target='_blank' rel='noreferrer'>
          <Button intent="primary">Deschide Pagina Github a Arhivei de Probleme</Button>
        </a>
      </Card>
      ...
      <Card elevation={3} style={cardStyle}>
        ...
        <p>Această platformă nu este platforma pe care se desfășoară concursul, ci există în scop educativ. Dacă găsiți o problemă (un bug), vă rugăm să îl raportați la link-ul de mai jos (veți avea nevoie de un cont de Github).</p>
        <a href="https://github.com/MateInfo-UB/MateInfo-UB.github.io/issues/new" target='_blank' rel='noreferrer'>
